...
@Component({
	selector: 'app-scholar-education-detail-modify',
	templateUrl: './scholar-education-detail-modify.component.html',
	styleUrls: ['./scholar-education-detail-modify.component.scss']
})
export class ScholarEducationDetailModifyComponent implements OnInit {
	...
	constructor(private scholarEducationDetailService:ScholarEducationDetailService,
		...
		this.scholarEducationDetail = this.navParams.get('scholarEducationDetail');
	...
	public save(scholarEducationDetail:ScholarEducationDetail) {
		...
		if (this.scholarEducationDetail.id === 0) {
			this.scholarEducationDetailService.save(scholarEducationDetail).subscribe((scholarEducationDetails) => {
				this.modalController.dismiss({ 'dismissed': true, 'scholarEducationDetails':scholarEducationDetails });
			}, (error) => {
					this.errorMessage = error.message;
			})
		} else {
