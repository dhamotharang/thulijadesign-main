...
@Component({
	selector: 'app-trainer-education-detail-manager-modify',
	templateUrl: './trainer-education-detail-manager-modify.component.html',
	styleUrls: ['./trainer-education-detail-manager-modify.component.css']
})
export class TrainerEducationDetailManagerModifyComponent implements OnInit {
	...
	constructor(private trainerEducationDetailService:TrainerEducationDetailService,
		...
		this.trainerEducationDetail = this.navParams.get('trainerEducationDetail');
	...
	public save(trainerEducationDetail:TrainerEducationDetail) {
		...
		if (this.trainerEducationDetail.id === 0) {
			this.trainerEducationDetailService.save(trainerEducationDetail).subscribe((trainerEducationDetails) => {
				this.modalController.dismiss({ 'dismissed': true, 'trainerEducationDetails':trainerEducationDetails });
			}, (error) => {
					this.errorMessage = error.message;
			})
		} else {
