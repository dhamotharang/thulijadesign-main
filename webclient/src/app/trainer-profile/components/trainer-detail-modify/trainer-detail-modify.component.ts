...
@Component({
	selector: 'app-trainer-detail-modify',
	templateUrl: './trainer-detail-modify.component.html',
	styleUrls: ['./trainer-detail-modify.component.css']
})
export class TrainerDetailModifyComponent implements OnInit {
	...
	constructor(private trainerDetailService:TrainerDetailService,
		...
		private dialogRef: MatDialogRef<TrainerDetailModifyComponent>,
		@Inject(MAT_DIALOG_DATA) public trainerDetail:TrainerDetail) {
	...
	public save(trainerDetail:TrainerDetail) {
		...
		if (this.trainerDetailForm.valid) {
			...
			this.validateAllFormFields(this.trainerDetailForm);
		}
	}
