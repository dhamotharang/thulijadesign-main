...
@Component({
	selector: 'app-trainer-manager-modify',
	templateUrl: './trainer-manager-modify.component.html',
	styleUrls: ['./trainer-manager-modify.component.css']
})
export class TrainerManagerModifyComponent implements OnInit {
	...
	constructor(private trainerService:TrainerService,
		...
		private dialogRef: MatDialogRef<TrainerManagerModifyComponent>,
	...
	public save(trainer:Trainer) {
		...
		if (this.trainerForm.valid) {
			...
			this.validateAllFormFields(this.trainerForm);
		}
	}
