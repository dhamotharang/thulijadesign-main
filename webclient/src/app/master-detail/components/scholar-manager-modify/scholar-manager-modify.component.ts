...
@Component({
	selector: 'app-scholar-manager-modify',
	templateUrl: './scholar-manager-modify.component.html',
	styleUrls: ['./scholar-manager-modify.component.css']
})
export class ScholarManagerModifyComponent implements OnInit {
	...
	constructor(private scholarService:ScholarService,
		...
		private dialogRef: MatDialogRef<ScholarManagerModifyComponent>,
		@Inject(MAT_DIALOG_DATA) public scholar:Scholar) {
	...
	public save(scholar:Scholar) {
		...
		if (this.scholarForm.valid) {
			...
			this.validateAllFormFields(this.scholarForm);
		}
	}
