...
@Component({
	selector: 'app-batch-prerequisite-manager-modify',
	templateUrl: './batch-prerequisite-manager-modify.component.html',
	styleUrls: ['./batch-prerequisite-manager-modify.component.css']
})
export class BatchPrerequisiteManagerModifyComponent implements OnInit {
	...
	constructor(private batchPrerequisiteService:BatchPrerequisiteService,
		...
		private dialogRef: MatDialogRef<BatchPrerequisiteManagerModifyComponent>,
	...
	public save(batchPrerequisite:BatchPrerequisite) {
		batchPrerequisite.batch = this.batchPrerequisite.batch;
		batchPrerequisite.options = this.batchPrerequisite.options;
