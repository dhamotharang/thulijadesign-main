...
@Component({
	selector: 'app-trainer-occupation-manager-modify',
	templateUrl: './trainer-occupation-manager-modify.component.html',
	styleUrls: ['./trainer-occupation-manager-modify.component.css']
})
export class TrainerOccupationManagerModifyComponent implements OnInit {
	...
	constructor(private trainerOccupationService:TrainerOccupationService,
		...
		private dialogRef: MatDialogRef<TrainerOccupationManagerModifyComponent>,
		@Inject(MAT_DIALOG_DATA) public trainerOccupation:TrainerOccupation) {
	...
	public save(trainerOccupation:TrainerOccupation) {
		...
		if (this.trainerOccupationForm.valid) {
			...
			this.validateAllFormFields(this.trainerOccupationForm);
		}
	}
