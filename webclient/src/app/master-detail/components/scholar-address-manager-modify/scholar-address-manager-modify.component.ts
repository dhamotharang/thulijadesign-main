...
@Component({
	selector: 'app-scholar-address-manager-modify',
	templateUrl: './scholar-address-manager-modify.component.html',
	styleUrls: ['./scholar-address-manager-modify.component.css']
})
export class ScholarAddressManagerModifyComponent implements OnInit {
	...
	constructor(private scholarAddressService:ScholarAddressService,
		...
		private dialogRef: MatDialogRef<ScholarAddressManagerModifyComponent>,
		@Inject(MAT_DIALOG_DATA) public scholarAddress:ScholarAddress) {
	...
	public save(scholarAddress:ScholarAddress) {
		...
		if (this.scholarAddressForm.valid) {
			...
			this.validateAllFormFields(this.scholarAddressForm);
		}
	}
