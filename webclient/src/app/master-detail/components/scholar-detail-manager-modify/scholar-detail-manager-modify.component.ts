...
@Component({
	selector: 'app-scholar-detail-manager-modify',
	templateUrl: './scholar-detail-manager-modify.component.html',
	styleUrls: ['./scholar-detail-manager-modify.component.css']
})
export class ScholarDetailManagerModifyComponent implements OnInit {
	...
	constructor(private scholarDetailService:ScholarDetailService,
		...
		private dialogRef: MatDialogRef<ScholarDetailManagerModifyComponent>,
		@Inject(MAT_DIALOG_DATA) public scholarDetail:ScholarDetail) {
	...
	public save(scholarDetail:ScholarDetail) {
		...
		if (this.scholarDetailForm.valid) {
			...
			this.validateAllFormFields(this.scholarDetailForm);
		}
	}
