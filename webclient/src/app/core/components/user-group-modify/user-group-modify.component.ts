...
@Component({
	selector: 'app-user-group-modify',
	templateUrl: './user-group-modify.component.html',
	styleUrls: ['./user-group-modify.component.css']
})
export class UserGroupModifyComponent implements OnInit {
	...
	constructor(private userGroupService:UserGroupService,
		...
		private dialogRef: MatDialogRef<UserGroupModifyComponent>,
