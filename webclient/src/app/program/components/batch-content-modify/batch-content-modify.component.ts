...
@Component({
	selector: 'app-batch-content-modify',
	templateUrl: './batch-content-modify.component.html',
	styleUrls: ['./batch-content-modify.component.css']
})
export class BatchContentModifyComponent implements OnInit {
	...
	constructor(private batchContentService:BatchContentService,
		...
		private dialogRef: MatDialogRef<BatchContentModifyComponent>,
